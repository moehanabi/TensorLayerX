...
class TestMindsporeBackend(CustomTestCase):
    ...
    def test_matmul(self):
        a = Tensor(np.random.rand(2, 3), float32)
        b = Tensor(np.random.rand(3, 2), float32)
        result = matmul(a, b)
    ...
    def test_add(self):
        a = Tensor(np.random.rand(2, 3), float32)
        b = Tensor(np.random.rand(2, 3), float32)
        result = add(a, b)
    ...
    def test_reshape(self):
        ...
        np.testing.assert_array_almost_equal(reshaped_tensor.asnumpy(), expected_output)
    ...
    def test_concat(self):
        ...
        np.testing.assert_array_almost_equal(concatenated_tensor.asnumpy(), expected_output)

    def test_convert_to_tensor(self):
        value = [1, 2, 3, 4]
        tensor = convert_to_tensor(value, dtype=np.float32)
        expected_output = np.array([1, 2, 3, 4], dtype=np.float32)
        np.testing.assert_array_almost_equal(tensor.asnumpy(), expected_output)

    def test_convert_to_numpy(self):
        tensor = Tensor(np.array([1, 2, 3, 4]))
        numpy_array = convert_to_numpy(tensor)
        expected_output = np.array([1, 2, 3, 4])
        np.testing.assert_array_almost_equal(numpy_array, expected_output)
    ...
    def test_sqrt(self):
        ...
        expected_output = np.array([1, 2, 3, 4], dtype=np.float32)
        np.testing.assert_array_almost_equal(sqrt_tensor.asnumpy(), expected_output)
    ...
    def test_stack(self):
        ...
        expected_output = np.array([[1, 2], [3, 4]])
        np.testing.assert_array_almost_equal(stacked_tensor.asnumpy(), expected_output)
    ...
    def test_meshgrid(self):
        ...
        np.testing.assert_array_almost_equal(grid_x.asnumpy(), expected_output_x)
        np.testing.assert_array_almost_equal(grid_y.asnumpy(), expected_output_y)
    ...
    def test_arange(self):
        ...
        np.testing.assert_array_almost_equal(arange_tensor.asnumpy(), expected_output)

    def test_expand_dims(self):
        tensor = Tensor(np.array([1, 2, 3]))
        expanded_tensor = expand_dims(tensor, axis=0)
        expected_output = np.array([[1, 2, 3]])
        np.testing.assert_array_almost_equal(expanded_tensor.asnumpy(), expected_output)

    def test_tile(self):
        tensor = Tensor(np.array([1, 2, 3]))
        tiled_tensor = tile(tensor, multiples=[2])
        expected_output = np.array([1, 2, 3, 1, 2, 3])
        np.testing.assert_array_almost_equal(tiled_tensor.asnumpy(), expected_output)
    ...
    def test_gather_nd(self):
        params = Tensor(np.random.rand(2, 3), float32)
        indices = Tensor([[0, 0], [1, 1]], int32)
    ...
    def test_split(self):
        a = Tensor(np.random.rand(6, 3), float32)
        result = split(a, 2)
    ...
    def test_floor(self):
        a = Tensor(np.random.rand(2, 3) + 0.5, float32)
        result = floor(a)
    ...
    def test_gather(self):
        ...
        np.testing.assert_array_almost_equal(gathered_tensor.asnumpy(), expected_output)
    ...
    def test_slice(self):
        a = Tensor(np.random.rand(4, 4), float32)
    ...
    def test_add_n(self):
        a = Tensor(np.random.rand(2, 3), float32)
        b = Tensor(np.random.rand(2, 3), float32)
        c = Tensor(np.random.rand(2, 3), float32)
        result = add_n([a, b, c])
        expected = a.asnumpy() + b.asnumpy() + c.asnumpy()
        np.testing.assert_array_almost_equal(result.asnumpy(), expected)

    def test_one_hot(self):
        indices = Tensor([0, 1, 2], int32)
        depth = 3
    ...
    def test_ceil(self):
        ...
        np.testing.assert_array_almost_equal(result.asnumpy(), expected.asnumpy())
    ...
    def test_identity(self):
        x = Tensor([1, 2, 3], ms.float32)
        result = identity(x)
        np.testing.assert_array_almost_equal(result.asnumpy(), x.asnumpy())
    ...
    def test_acos(self):
        ...
        np.testing.assert_array_almost_equal(result.asnumpy(), expected, decimal=2)
    ...
    def test_any(self):
        ...
        np.testing.assert_array_almost_equal(output_axis_0.asnumpy(), expected_axis_0)

        expected_axis_1 = np.any(x.asnumpy(), axis=1)
        output_axis_1 = any(x, axis=1)
        np.testing.assert_array_almost_equal(output_axis_1.asnumpy(), expected_axis_1)
    ...
    # def test_log(self):
    #     a = Tensor(np.random.rand(2, 3) + 1, float32)
    #     result = log(a)
    ...
    def test_logical_and(self):
        a = Tensor(np.random.rand(2, 3) > 0.5, bool)
        b = Tensor(np.random.rand(2, 3) > 0.5, bool)
    ...
    def test_argsort(self):
        ...
        np.testing.assert_array_almost_equal(output_descending.asnumpy(), expected_descending)
    ...
    def test_where(self):
        condition = Tensor(np.random.rand(2, 3) > 0.5, bool)
        a = Tensor(np.random.rand(2, 3), float32)
        b = Tensor(np.random.rand(2, 3), float32)
    ...
    def test_squeeze(self):
        a = Tensor(np.random.rand(1, 2, 3, 1), float32)
        result = squeeze(a)
    ...
    def test_unsorted_segment_sum(self):
        a = Tensor(np.random.rand(6, 3), float32)
        segment_ids = Tensor([0, 1, 2, 0, 1, 2], int32)
        num_segments = 3
